            ...
            <div className="w-2/5 px-5 mt-7 mb-5 border-l border-gray-300">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-300">
                    ...
                    <div className="flex items-end flex-col">
                        ...
                        <button className="text-sm-md">
                            Đổi địa chỉ
                        </button>

                        <form className=" rounded-md w-[290px] bg-[#f7f7f7] flex flex-col items-center py-3 px-5 mt-2">
                            <input className="border border-gray-300 pl-2 py-1 mb-2 w-full" type="text" placeholder="Thành phố" />
                            <input className="border border-gray-300 pl-2 py-1 mb-2 w-full" type="text" placeholder="Mã bưu điện" />
                            <button className="bg-yellow-1 py-1 w-full font-medium text-white">
                                Cập nhật
                            </button>
                        </form>  
                    </div>
                ...
                <button className="w-full py-2 text-white font-medium uppercase bg-[#d26e4b] hover:bg-[#a8583c] my-3">
